...
?>
    ...
    <div class="box">
       <div class="box-header">
          <button class="btn btn-success" onclick="add_lok()"><i class="glyphicon glyphicon-plus"></i> Tambah Lokasi</button>
        </div>
            <!-- /.box-header -->
               ...
               <tr>
                  ...
                  <th>Action</th>
                   ...
                   <?php foreach($h->result() as $row){?> 
                       ...
                       <td>
                  <button class="btn btn-warning" onclick="lok_edit(<?php echo $row->id_lok;?>)"><i class="glyphicon glyphicon-pencil"></i></button>
                  <button class="btn btn-danger" onclick="delete_kat(<?php echo $row->id_lok;?>)"><i class="glyphicon glyphicon-remove"></i></button>
                </td>
                </tr>               
                 <?php }?>
